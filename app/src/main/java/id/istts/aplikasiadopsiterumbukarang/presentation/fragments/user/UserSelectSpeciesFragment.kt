 ...
 * Use the [UserSelectSpeciesFragment.newInstance] factory method to
...
class UserSelectSpeciesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserSelectSpeciesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserSelectSpeciesFragment().apply {
