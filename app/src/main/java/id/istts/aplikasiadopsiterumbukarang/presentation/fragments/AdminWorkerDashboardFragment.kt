 ...
 * Use the [AdminWorkerDashboardFragment.newInstance] factory method to
...
class AdminWorkerDashboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminWorkerDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminWorkerDashboardFragment().apply {
